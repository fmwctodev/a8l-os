...
export const dataSourceConfigs: Record<ReportDataSource, DataSourceConfig> = {
  ...
  opportunities: {
    ...
    dimensions: [
      { field: 'created_at', label: 'Created Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'updated_at', label: 'Updated Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'closed_at', label: 'Closed Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'status', label: 'Status', dataType: 'string' },
      { field: 'pipeline_id', label: 'Pipeline', dataType: 'string' },
      { field: 'stage_id', label: 'Stage', dataType: 'string' },
      { field: 'owner_id', label: 'Owner', dataType: 'string' },
      { field: 'source', label: 'Source', dataType: 'string' },
      { field: 'currency', label: 'Currency', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Opportunities', aggregation: 'count' },
      { field: 'value_amount', label: 'Total Value', aggregation: 'sum', format: 'currency' },
      { field: 'value_amount', label: 'Average Value', aggregation: 'avg', format: 'currency' },
      { field: 'value_amount', label: 'Min Value', aggregation: 'min', format: 'currency' },
      { field: 'value_amount', label: 'Max Value', aggregation: 'max', format: 'currency' },
      { field: 'status_won', label: 'Won Count', aggregation: 'count' },
      { field: 'status_lost', label: 'Lost Count', aggregation: 'count' },
      { field: 'contact_id', label: 'Unique Contacts', aggregation: 'count_distinct' },
    ],
  },
  ...
  invoices: {
    ...
    dimensions: [
      { field: 'created_at', label: 'Created Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'due_date', label: 'Due Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'paid_at', label: 'Paid Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'status', label: 'Status', dataType: 'string' },
      { field: 'currency', label: 'Currency', dataType: 'string' },
      { field: 'contact_id', label: 'Contact', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Invoices', aggregation: 'count' },
      { field: 'total_amount', label: 'Total Amount', aggregation: 'sum', format: 'currency' },
      { field: 'total_amount', label: 'Average Amount', aggregation: 'avg', format: 'currency' },
      { field: 'paid_amount', label: 'Total Paid', aggregation: 'sum', format: 'currency' },
      { field: 'balance_due', label: 'Total Outstanding', aggregation: 'sum', format: 'currency' },
      { field: 'status_paid', label: 'Paid Count', aggregation: 'count' },
      { field: 'status_overdue', label: 'Overdue Count', aggregation: 'count' },
      { field: 'contact_id', label: 'Unique Contacts', aggregation: 'count_distinct' },
    ],
  },
  ...
  payments: {
    label: 'Payments',
    primaryDateField: 'payment_date',
    baseTable: 'payments',
    dimensions: [
      { field: 'payment_date', label: 'Payment Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'created_at', label: 'Created Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'status', label: 'Status', dataType: 'string' },
      { field: 'payment_method', label: 'Payment Method', dataType: 'string' },
      { field: 'currency', label: 'Currency', dataType: 'string' },
      { field: 'invoice_id', label: 'Invoice', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Payments', aggregation: 'count' },
      { field: 'amount', label: 'Total Amount', aggregation: 'sum', format: 'currency' },
      { field: 'amount', label: 'Average Amount', aggregation: 'avg', format: 'currency' },
      { field: 'amount', label: 'Min Amount', aggregation: 'min', format: 'currency' },
      { field: 'amount', label: 'Max Amount', aggregation: 'max', format: 'currency' },
      { field: 'invoice_id', label: 'Unique Invoices', aggregation: 'count_distinct' },
    ],
  },
  ...
  tasks: {
    label: 'Tasks',
    primaryDateField: 'created_at',
    baseTable: 'contact_tasks',
    dimensions: [
      { field: 'created_at', label: 'Created Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'due_date', label: 'Due Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'completed_at', label: 'Completed Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'status', label: 'Status', dataType: 'string' },
      { field: 'priority', label: 'Priority', dataType: 'string' },
      { field: 'task_type', label: 'Task Type', dataType: 'string' },
      { field: 'assigned_to', label: 'Assigned To', dataType: 'string' },
      { field: 'contact_id', label: 'Contact', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Tasks', aggregation: 'count' },
      { field: 'status_completed', label: 'Completed', aggregation: 'count' },
      { field: 'status_pending', label: 'Pending', aggregation: 'count' },
      { field: 'status_overdue', label: 'Overdue', aggregation: 'count' },
      { field: 'contact_id', label: 'Unique Contacts', aggregation: 'count_distinct' },
      { field: 'assigned_to', label: 'Unique Assignees', aggregation: 'count_distinct' },
    ],
  },
  ...
  ai_runs: {
    label: 'AI Agent Runs',
    primaryDateField: 'started_at',
    baseTable: 'ai_agent_runs',
    dimensions: [
      { field: 'started_at', label: 'Started Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'finished_at', label: 'Finished Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'agent_id', label: 'Agent', dataType: 'string' },
      { field: 'status', label: 'Status', dataType: 'string' },
      { field: 'trigger_type', label: 'Trigger Type', dataType: 'string' },
      { field: 'triggered_by', label: 'Triggered By', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Runs', aggregation: 'count' },
      { field: 'status_completed', label: 'Completed', aggregation: 'count' },
      { field: 'status_failed', label: 'Failed', aggregation: 'count' },
      { field: 'tokens_used', label: 'Total Tokens', aggregation: 'sum' },
      { field: 'tokens_used', label: 'Average Tokens', aggregation: 'avg' },
      { field: 'execution_time_ms', label: 'Total Execution Time (ms)', aggregation: 'sum', format: 'duration' },
      { field: 'execution_time_ms', label: 'Avg Execution Time (ms)', aggregation: 'avg', format: 'duration' },
      { field: 'agent_id', label: 'Unique Agents', aggregation: 'count_distinct' },
    ],
  },
  ...
  marketing: {
    ...
    dimensions: [
      { field: 'submitted_at', label: 'Submitted Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'form_id', label: 'Form', dataType: 'string' },
      { field: 'utm_source', label: 'UTM Source', dataType: 'string' },
      { field: 'utm_medium', label: 'UTM Medium', dataType: 'string' },
      { field: 'utm_campaign', label: 'UTM Campaign', dataType: 'string' },
      { field: 'processed_status', label: 'Processing Status', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Submissions', aggregation: 'count' },
      { field: 'contact_id', label: 'Unique Leads', aggregation: 'count_distinct' },
      { field: 'converted', label: 'Conversions', aggregation: 'count' },
      { field: 'form_id', label: 'Unique Forms', aggregation: 'count_distinct' },
    ],
  },

  reputation: {
    label: 'Reviews & Reputation',
    primaryDateField: 'received_at',
    baseTable: 'reviews',
    dimensions: [
      { field: 'received_at', label: 'Received Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'created_at', label: 'Created Date', dataType: 'date', supportsDateGrouping: true },
      { field: 'provider', label: 'Provider', dataType: 'string' },
      { field: 'rating', label: 'Rating', dataType: 'number' },
      { field: 'sentiment', label: 'Sentiment', dataType: 'string' },
      { field: 'status', label: 'Status', dataType: 'string' },
    ],
    metrics: [
      { field: 'id', label: 'Total Reviews', aggregation: 'count' },
      { field: 'rating', label: 'Average Rating', aggregation: 'avg' },
      { field: 'rating', label: 'Min Rating', aggregation: 'min' },
      { field: 'rating', label: 'Max Rating', aggregation: 'max' },
      { field: 'sentiment_positive', label: 'Positive Reviews', aggregation: 'count' },
      { field: 'sentiment_negative', label: 'Negative Reviews', aggregation: 'count' },
      { field: 'sentiment_neutral', label: 'Neutral Reviews', aggregation: 'count' },
    ],
  },
};
