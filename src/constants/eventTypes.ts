export const WorkflowTriggerType = {
  ...
  CONTACT_TAG_CHANGED: 'contact_tag_changed',
  CONTACT_STATUS_CHANGED: 'contact_status_changed',
  CONTACT_OWNER_ASSIGNED: 'contact_owner_assigned',
  CONTACT_DND_CHANGED: 'contact_dnd_changed',
  CONTACT_CUSTOM_DATE_REMINDER: 'contact_custom_date_reminder',
  CONTACT_NOTE_ADDED: 'contact_note_added',
  CONTACT_NOTE_CHANGED: 'contact_note_changed',
  CONTACT_TASK_ADDED: 'contact_task_added',
  CONTACT_TASK_REMINDER: 'contact_task_reminder',
  CONTACT_TASK_COMPLETED: 'contact_task_completed',
  ...
  APPOINTMENT_CUSTOMER_BOOKED: 'appointment_customer_booked',
  ...
  EVENT_CALL_DETAILS: 'event_call_details',
  EVENT_EMAIL: 'event_email',
  EVENT_CUSTOMER_REPLIED: 'event_customer_replied',
  EVENT_CONVERSATION_AI: 'event_conversation_ai',
  EVENT_CUSTOM: 'event_custom',
  EVENT_FORM_SUBMITTED: 'event_form_submitted',
  EVENT_SURVEY_SUBMITTED: 'event_survey_submitted',
  EVENT_REVIEW_RECEIVED: 'event_review_received',
  EVENT_PROSPECT_GENERATED: 'event_prospect_generated',
